...
--
-- Host: localhost:3306
-- Generation Time: Nov 28, 2019 at 02:08 AM
...
(3, 5, 2, 12, '2019-11-27 12:48:55'),
(4, 3, 1, 12, '2019-11-27 13:01:29'),
(5, 3, 1, 12, '2019-11-27 13:04:39');
...
INSERT INTO `cliente` (`id`, `id_tipo_de_documento`, `documento`, `nombre`, `apellido`, `direccion`, `telefono`, `datos_personales`) VALUES
(10, 1, 27, 'Mariangelis', 'Escobar', 'Un lugar muy muy lejano', '+582856590483', 0);
...
(2, 'Kledany', 'Barzola', 1, '25695518', '+584120890503', 'Urb.'),
(3, 'Samuel', 'Trias', 1, '24186725', '', 'Marhuanta'),
(4, 'Saul', 'Yanave', 1, '21333222', '+584127969795', 'Urbanización...'),
(5, 'Mariangelis', 'Escobar', 1, '27486197', '', 'Un lugar muy muy lejano');
...
INSERT INTO `libro` (`id_libro`, `titulo`, `id_autor`, `id_categoria`, `fecha_lanzamiento`, `cantidad`, `precio`, `ruta_imagen`, `sinopsis`) VALUES
(3, 'Pablo escobar Mi padre', 4, 1, '2017-09-28', 102, '463', 'uploaded_files/img_books/2.jpg', 'Pasaron más de veinte años.'),
(5, 'La reina roja', 7, 4, '2019-01-21', 61, '730', 'uploaded_files/img_books/1.jpg', 'Alerta de spoilers! La protagonista tiene poderes que nadie sabia y es de sangre roja pero con poderes plateados...'),
(8, 'Prueba img', 2, 2, '2018-11-30', 87, '870', NULL, 'prueba'),
(9, 'prueba', 3, 2, '2017-10-29', 11, '911', 'uploaded_files/img_books/mbiopb90k4evsb1gwh0a.jpeg', 'prueba');
...
--
ALTER TABLE `abastecer`
  MODIFY `id_abastecer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `datos_personales`
  MODIFY `id_datos_personales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
ALTER TABLE `abastecer`
  ...
  ADD CONSTRAINT `abastecer_ibfk_2` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id`);
